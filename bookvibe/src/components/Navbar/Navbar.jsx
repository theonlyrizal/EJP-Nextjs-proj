...
const Navbar = () => {
  ...
  const getLinkClassName = (href) => {
    ...
    const activeClasses = isActive
      ? `${baseClasses} bg-primary text-primary-content`
      : `${baseClasses} hover:bg-base-300`;
  ...
  const links = (
    <>
      ...
      <li>
        <Link className={getLinkClassName('/books')} href="/books">
          Books
        </Link>
      </li>

      <li>
        <Link className={getLinkClassName('/add-books')} href="/add-books">
          Add Book
        </Link>
      </li>
  ...
  return (
    <div className="navbar fixed bg-base-100 shadow-sm z-15">
        ...
        {user ? (
          <div className="dropdown dropdown-end hover:cursor-pointer">
            ...
            >
              ...
              <li>
                <Link href="/manage-books">Manage Books</Link>
              </li>
              <li>
                <button
                  onClick={async () => {
